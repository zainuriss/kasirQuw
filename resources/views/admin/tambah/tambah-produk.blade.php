                    ...
                    <form method="POST" action="{{ route('admin.produk.store') }}">
                        ...
                        <div class="grid grid-cols-2 gap-6">
                            ...
                            <div>
                                ...
                                <x-text-input id="nama_produk" class="mt-1 block w-full" type="text" name="nama_produk" :value="old('nama_produk')" required autofocus autocomplete="nama_produk" />
                                <x-input-error :messages="$errors->get('nama_produk')" class="mt-2" />
                            </div>
                        
                            <div>
                                <x-input-label for="barcode" :value="__('Barcode')" />
                                <x-text-input id="barcode" class="mt-1 block w-full" type="text" name="barcode" :value="old('barcode')" required autofocus autocomplete="barcode" />
                                <x-input-error :messages="$errors->get('barcode')" class="mt-2" />
                            </div>
                        
                            <div>
                                <x-input-label for="harga_beli" :value="__('Harga Beli')" />
                                <x-text-input id="harga_beli" class="mt-1 block w-full" type="text" name="harga_beli" required autocomplete="harga_beli" />
                                <x-input-error :messages="$errors->get('harga_beli')" class="mt-2" />
                            </div>
                        
                            <div>
                                <x-input-label for="harga_jual" :value="__('Harga Jual')" />
                                <x-text-input id="harga_jual" class="mt-1 block w-full" type="text" name="harga_jual" required autocomplete="harga_jual" />
                                <x-input-error :messages="$errors->get('harga_jual')" class="mt-2" />
                            </div>
                        
                            <div>
                                <x-input-label for="stok" :value="__('Stok')" />
                                <x-text-input id="stok" class="mt-1 block w-full" type="text" name="stok" :value="old('stok')" required autofocus autocomplete="stok" />
